...
const apply_pattern_dto_1 = require("./dto/apply-pattern.dto");
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ReminderPatternController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ReminderPatternController.prototype, "remove", null);
__decorate([
    (0, common_1.Post)(':id/apply'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, apply_pattern_dto_1.ApplyPatternDto]),
    __metadata("design:returntype", void 0)
], ReminderPatternController.prototype, "apply", null);
exports.ReminderPatternController = ReminderPatternController = __decorate([
    (0, common_1.Controller)('reminder-patterns'),
    __metadata("design:paramtypes", [reminder_pattern_service_1.ReminderPatternService])
], ReminderPatternController);
//# sourceMappingURL=reminder-pattern.controller.js.map